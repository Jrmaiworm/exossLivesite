...
export const EstacaoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="exossLivesiteApp.estacao.delete.question">
        <Translate contentKey="exossLivesiteApp.estacao.delete.question" interpolate={{ id: estacaoEntity.id }}>
          Are you sure you want to delete this Estacao?
        </Translate>
      </ModalBody>
      <ModalFooter>
